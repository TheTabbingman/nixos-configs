        ...
        ''
          ...
          environment {
           ...
           binds {
               ...
               Mod+Alt+Ctrl+v hotkey-overlay-title="Check vrr" { spawn "vrrcheck"; }
               ...
               Mod+E hotkey-overlay-title="Open a File Manager: yazi" { spawn-sh "${lib.getExe pkgs.ghostty} -e ${lib.getExe pkgs.fish} -i -c 'y; exec fish'"; }
               ...
               Mod+Shift+Alt+j    { move-workspace-down; }
               Mod+Shift+Alt+k    { move-workspace-up; }
